...
python3 train_scinet.py --gpu_num 1 --dataset 'etth1' --scaler 'LayerNorm'
python3 train_scinet.py --gpu_num 1 --dataset 'etth1' --scaler 'InstanceNorm'
...
python3 train_scinet.py --gpu_num 1 --dataset 'etth2' --scaler 'LayerNorm'
python3 train_scinet.py --gpu_num 1 --dataset 'etth2' --scaler 'InstanceNorm'
...
python3 train_scinet.py --gpu_num 1 --dataset 'ettm1' --scaler 'LayerNorm'
python3 train_scinet.py --gpu_num 1 --dataset 'ettm1' --scaler 'InstanceNorm'
...
python3 train_scinet.py --gpu_num 1 --dataset 'ettm2' --scaler 'LayerNorm'
python3 train_scinet.py --gpu_num 1 --dataset 'ettm2' --scaler 'InstanceNorm'
