...
python3 train_informer.py --gpu_num 2 --dataset 'etth1' --scaler 'LayerNorm'
python3 train_informer.py --gpu_num 2 --dataset 'etth1' --scaler 'InstanceNorm'
...
python3 train_informer.py --gpu_num 2 --dataset 'etth2' --scaler 'LayerNorm'
python3 train_informer.py --gpu_num 2 --dataset 'etth2' --scaler 'InstanceNorm'
...
python3 train_informer.py --gpu_num 2 --dataset 'ettm1' --scaler 'LayerNorm'
python3 train_informer.py --gpu_num 2 --dataset 'ettm1' --scaler 'InstanceNorm'
...
python3 train_informer.py --gpu_num 2 --dataset 'ettm2' --scaler 'LayerNorm'
python3 train_informer.py --gpu_num 2 --dataset 'ettm2' --scaler 'InstanceNorm'
